        ...
        Group {
            if isEmptyState(tab) {
                ...
                JsonTreeView(
                    ...
                    stringValueColor: Color(hex: appState.settings.appearanceTheme.treeStringHexColor) ?? .secondary,
                    booleanValueColor: Color(hex: appState.settings.appearanceTheme.treeBooleanHexColor) ?? .secondary,
                    numberValueColor: Color(hex: appState.settings.appearanceTheme.treeNumberHexColor) ?? .secondary,
                    nullValueColor: Color(hex: appState.settings.appearanceTheme.treeNullHexColor) ?? .secondary,
